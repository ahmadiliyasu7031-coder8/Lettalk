...
class PermissionService {
  ...
  /// For returning users, who skip the onboarding screens entirely:
  /// silently (re)requests anything still missing before Uranium starts.
  /// Without this, a permission added in a later app update (like
  /// bluetoothAdvertise) would never get asked for on an existing install.
  static Future<void> ensureAllGranted() async {
    try {
      await [
        Permission.bluetoothScan,
        Permission.bluetoothConnect,
