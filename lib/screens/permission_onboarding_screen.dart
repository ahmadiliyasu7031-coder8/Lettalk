...
class _PermissionOnboardingScreenState
  ...
  static const _steps = [
    _PermissionStep(
      ...
      description:
          'Lettalk needs Bluetooth to discover and connect to nearby devices. '
          'This is how messages travel through the mesh — device to device, '
    ...
    _PermissionStep(
      ...
      description:
          'On Android 12 and above, Lettalk also needs the Nearby Devices '
          'permission to scan for and connect to other Lettalk users around you.',
  ...
  Future<void> _requestCurrent() async {
    ...
    try {
      await _steps[_step].permission.request();
    } catch (_) {}
