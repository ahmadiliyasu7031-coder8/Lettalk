  ...
  Future<void> _continue() async {
    ...
    try {
      await ref.read(identityProvider.notifier).createIdentity(
            ...
            lettalkId: _previewLettalkId,
          );

      // Start Uranium in background — never await this before navigating.
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'Choose a username. Your Lettalk ID is generated automatically.',
                ...
                child: Row(
                  children: [
                    ...
                    IconButton(
                      ...
                      onPressed: () {
                        Clipboard.setData(
                            ClipboardData(text: _previewLettalkId));
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                              content: Text('Lettalk ID copied')),
                        );
                      },
                    ),
                  ],
